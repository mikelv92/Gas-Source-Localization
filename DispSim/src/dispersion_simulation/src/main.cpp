...
int main(int argc, char **argv) {
	...
	algorithm_init(input_wind_data.c_str(),input_snapshots,input_filament_number,input_area_size_x,input_area_size_y,input_area_size_z,input_area_cell_size,input_source_pos_x,input_source_pos_y,input_source_pos_z, input_spreading_width);
