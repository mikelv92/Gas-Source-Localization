...
void flow_init( struct sFlow *flow,int area_size_x, int area_size_y, int area_size_z, double area_cell_size) {
	...
	/*
	flow->max_x=(int)area_size_x/area_cell_size;
	flow->max_y=(int)area_size_y/area_cell_size;
	flow->max_z=(int)area_size_z/area_cell_size;*/

	//flow->r=alloc_data(area_size_x, area_size_y, area_size_z);
	/*
	flow->u=arr3dAlloc((int)area_size_x/area_cell_size, (int)area_size_y/area_cell_size, (int)area_size_z/area_cell_size);
	flow->v=arr3dAlloc((int)area_size_x/area_cell_size, (int)area_size_y/area_cell_size, (int)area_size_z/area_cell_size);
	flow->w=arr3dAlloc((int)area_size_x/area_cell_size, (int)area_size_y/area_cell_size, (int)area_size_z/area_cell_size);*/
